...
const cmsDependencies: Record<string, Dependency> = {
  ...
  '@/app/components/PrimaryButton': {
    module: PrimaryButton
  },
  '@/app/components/SecondaryButton': {
    module: SecondaryButton
  },
  '@/app/components/Input': {
    module: Input
  },
  '@/app/components/CardOne': {
    module: CardOne
  },
  '@/app/components/CardTwo': {
    module: CardTwo
  },
  '@/app/components/CardThree': {
    module: CardThree
  },
  '@/app/components/CardFour': {
    module: CardFour
  },
  '@/app/components/CardFive': {
    module: CardFive
  },
  '@/app/components/CardSix': {
    module: CardSix
  },
  '@/app/components/CardSeven': {
    module: CardSeven
  },
  '@/app/components/CardEight': {
    module: CardEight
  },
  '@/app/components/CardNine': {
    module: CardNine
  },
  '@/app/components/CardCarousel': {
    module: CardCarousel
  },
  '@/app/components/SwiperCarousel': {
    module: SwiperCarousel
  },
  '@/app/components/HeroImage': {
    module: HeroImage
  },
  '@/app/components/FAQAccordion': {
    module: FAQAccordion
  },
  '@/app/components/HeadingOne': {
    module: HeadingOne
  },
  '@/app/components/HeadingTwo': {
    module: HeadingTwo
  },
  '@/app/components/HeadingThree': {
    module: HeadingThree
  },
  '@/app/components/HeadingThreeCaps': {
    module: HeadingThreeCaps
  },
  '@/app/components/DisplayOne': {
    module: DisplayOne
  },
  '@/app/components/DisplayTwo': {
    module: DisplayTwo
  },
  '@/app/components/DisplayThree': {
    module: DisplayThree
  },
  '@/app/components/BodyOne': {
    module: BodyOne
  },
  '@/app/components/BodyTwo': {
    module: BodyTwo
  },
  '@/app/components/BodyThree': {
    module: BodyThree
  },
  '@/app/components/BodyFour': {
    module: BodyFour
  },
  '@/app/components/SubTitleThree': {
    module: SubTitleThree
  },
  '@/app/components/SubTitleFour': {
    module: SubTitleFour
  },
  '@/app/components/SubTitleFive': {
    module: SubTitleFive
  },
  '@/app/components/SubTitleFiveCaps': {
    module: SubTitleFiveCaps
  },
  '@/app/components/SubTitileFourCaps': {
    module: SubTitileFourCaps
  },
  '@/app/components/PriceCard': {
    module: PriceCard
  },
  '@/app/components/SectionCard': {
    module: SectionCard
  },
  '@/app/components/BenefitIcon': {
    module: BenefitIcon
  },
  '@/app/components/BillingToggle': {
    module: BillingToggle
  },
  '@/app/components/ComparisonTable': {
    module: ComparisonTable
  },
  '@/app/components/CMSFeatureTable': {
    module: CMSFeatureTable
  },
  '@/app/components/Demo': {
    module: Demo
  },
  '@/app/components/LatestPost': {
    module: LatestPost
  },
  '@/app/components/BlogClient': {
    module: BlogClient
  },
  '@/app/components/BlogSingleClient': {
    module: BlogSingleClient
  },
  '@/app/components/ResultImage': {
    module: ResultImage
  },
  ...
  '@/app/components/home/home-section-typography': {
    module: homeSectionTypography
  },
  '@/app/lib/home-faq-data': {
    module: homeFaqData
  },
  '@/app/components/site-header/BilditLogo': {
    module: {
      BilditLogo
    }
  },
