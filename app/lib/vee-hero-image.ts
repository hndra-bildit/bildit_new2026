/**
 * Full-bleed pink line-art field behind the hero (`public/images/bg-pink.svg`).
 */
export const VEE_HERO_BG = '/images/bg-pink.svg'

/**
 * Figma: BILDIT Website 2025 — hero “main images” (node 4995:19614).
