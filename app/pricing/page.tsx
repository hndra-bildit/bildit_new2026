...
const PriceCardItems:Array<PriceCardItemType>=[
    { 
        ...
        isPopular:false, 
        title:"Scale", 
        content:"For large scale enterprises with a lot of traffic, we have custom options available with additional support hours, engineering, training, and implementation.",
        url:"#",
        subItems:[
    ...
    return(
        <>
            <section className="pt-[160px] px-4 lg:px-0">
                ...
                />
                <SubTitleThree 
                    content="With Higher Impact Across Digital Marketing Channels."
            ...
            <section className="relative py-[100px] overflow-hidden px-4 lg:px-0">
                <Image src={BG_Frequently_Ask} className="lg:block hidden  absolute z-[-1] top-0 " alt="BG_Frequently_Ask.png" style={{ width: '100%', height: '100%'}}/> 
                <Image src={BG_Frequently_Ask_Mobile} className="show lg:hidden absolute z-[-1] top-0 left-0" alt="BG_Frequently_Ask.png" style={{ width: '100%', height: 'auto'}}/> 
