...
const features = [
  {
    ...
    description:
      "Create campaigns for web, mobile, email and push notifications from one CMS",
  },
  {
    title: "Unlimited users",
    description:
      "Add as many team members as you need for simultaneous editing and updates",
  },
  {
  ...
  },
  {
    ...
    description:
      "Focus on growth without worrying about storage restrictions",
  },
  {
    title: "Code library",
    description:
      "Code-as-content library for the most common types of campaigns — no coding experience necessary",
  },
  {
    title: "Multiple content types",
    description:
      "Build and deploy banners, product carousels, GIFs, videos and more",
  },
  {
    title: "Drag-and-drop builder",
    description:
      "Sort banner order display by dragging and dropping content snippets within CMS",
  },
  {
    title: "Native preview",
    description:
      "Preview code before pushing it into production, for iOS, Android, and web",
  },
  {
    title: "Automated archiving",
    description:
      "Stop wasting time on removing expired campaigns with automated content archiving",
  },
  {
