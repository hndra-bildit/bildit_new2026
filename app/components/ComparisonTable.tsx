...
const data: Array<dataProps> = [
  ...
  { feature: "Bandwidth (per Mo)", bildit: "Unlimited", sanity: "1TB", contentstack: "2TB", storyblock: "2 TB Traffic/Mo Included (Cumulative 24 TB/Y)" },
  { feature: "Additional bandwidth", bildit: "✅", sanity: "$1 per 10GB", contentstack: "❌", storyblock: "$190/Mo for 1 TB of additional traffic" },
  { feature: "Document", bildit: "Unlimited", sanity: "50K", contentstack: "❌", storyblock: "❌" },
  { feature: "Unique attribute (per dataset)", bildit: "Unlimited", sanity: "10K", contentstack: "❌", storyblock: "❌" },
  { feature: "Other Limitations", bildit: "Unlimited", sanity: "Unlimited Playground Projects", contentstack: "❌", storyblock: "3 Spaces Included" },
  ...
  { feature: "Other Limitations", bildit: "Unlimited", sanity: "❌", contentstack: "50+ Content Types", storyblock: "❌" },
  { feature: "Other Limitations", bildit: "Unlimited", sanity: "❌", contentstack: "10+ Languages/Locals", storyblock: "❌" },
  ...
  { feature: "Uptime", bildit: "99.95% Uptime SLA (Firebase)", sanity: "❌", contentstack: "Available", storyblock: "99.9% Uptime SLA" },
  { feature: "Activity Log", bildit: "Activity Log", sanity: "Full audit trail & History API", contentstack: "Full audit trail & History API", storyblock: "Extended Activity Log" },
  { feature: "Activity Log", bildit: "Access Logs In GCP", sanity: "Access Logs", contentstack: "❌", storyblock: "Restricted IP Address Range" },
  { feature: "Analytics", bildit: "RefApp Analytics", sanity: "❌", contentstack: "Advance Analytics", storyblock: "Organization Analytics" },
  { feature: "Support", bildit: "Slack Support", sanity: "Community Support", contentstack: "❌", storyblock: "Extended Support (Optional)" },
  { feature: "Security", bildit: "❌", sanity: "❌", contentstack: "❌", storyblock: "Security Audit (Optional)" },
  { feature: "Access Control", bildit: "✅", sanity: "Single Sign On (SSO)", contentstack: "❌", storyblock: "Single Sign On (Optional)" },
  { feature: "Access Control", bildit: "❌", sanity: "Custom Access Control", contentstack: "❌", storyblock: "❌" },
  { feature: "Payment Option", bildit: "Invoicing", sanity: "Pay by Card", contentstack: "❌", storyblock: "Single Sign On (Optional)" },
  { feature: "Onboarding", bildit: "Onboarding & Training", sanity: "❌", contentstack: "❌", storyblock: "❌" },
  { feature: "Customer Support Contact", bildit: "Direct Contact", sanity: "❌", contentstack: "Customer Success Manager", storyblock: "❌" },
  ...
  { feature: "Other Features", bildit: "Backups", sanity: "❌", contentstack: "10+ Languages/Locals", storyblock: "S3 Backups and Restore" },
  { feature: "Content Scheduling", bildit: "Scheduled Publishing", sanity: "❌", contentstack: "Scheduling and Release", storyblock: "❌" }
];
