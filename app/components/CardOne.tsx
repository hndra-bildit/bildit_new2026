    ...
    return (
        <div className="w-[320px] mt-12 mx-5">
            ...
            <div className="text-center">
                <h5 className="text-3xl leading-[100%] text-black-one font-bold mt-9 font-gt-walsheim h-[74px]">{item.title}</h5>
                <p className="text-xl leading-[32px] text-grey">{item.content}</p>
            </div>
        </div>
