  ...
  return (
    <section className={`relative w-full overflow-hidden py-16 lg:py-24 ${className}`}>
      <div className="pointer-events-none absolute inset-0 z-0">
        ...
        <img
          src="/images/archive/insta-stories.gif"
          alt=""
            ...
            <div className="space-y-6">
              <h1 className="text-5xl lg:text-7xl xl:text-8xl font-black leading-[0.85] tracking-[0.05em]">
                ...
                <span
                  ...
                  style={{
                    background:
                      'linear-gradient(135deg, #3B1DED 0%, #ED1E79 22.85%, #EB6751 50.6%, #ED1E79 70.97%, #3B1DED 100%)',
              ...
              <p className="text-lg lg:text-xl xl:text-2xl text-gray-600 leading-relaxed max-w-2xl mx-auto lg:mx-0">
                Say goodbye to the hassle of juggling multiple tools. Our cutting-edge CMS brings everything you need
                into one seamless platform, designed for modern e-commerce businesses.
              </p>
            </div>
          </div>
