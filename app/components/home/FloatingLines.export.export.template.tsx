...
import { Clock, Mesh, OrthographicCamera, PlaneGeometry, Scene, ShaderMaterial, Vector2, Vector3, WebGLRenderer } from "@/cmsDependencies";
const vertexShader = `
...
export default function FloatingLines({
  ...
  return <div ref={containerRef} className="relative w-full h-full overflow-hidden floating-lines-container" style={{
