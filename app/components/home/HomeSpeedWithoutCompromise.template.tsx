// HomeSpeedWithoutCompromise:v3 legacy=false
// @template v2
...
export function HomeSpeedWithoutCompromise({ className }) {
  /**
   * @group div
   * @type RichText
   */
  const headerH2Text = 'No Limitations.'
  /**
   * @group div
   * @type RichText
   */
  const headerPText = 'Visual Experience Engine'
  return (
    <section
      className={cn(
    ...
    >
      <div className="relative flex flex-col gap-10 py-16 md:gap-12 md:py-20 lg:py-24">
        ...
        >
          <p
            className={cn(homeSectionEyebrowClassName, 'text-neutral-900')}
            data-bildit-var-name="headerPText"
          ...
          <h2
            ...
            data-bildit-var-name="headerH2Text"
            data-bildit-var-type="RichText"
          >
            {headerH2Text}
          </h2>
          <p
            className={cn(homeSectionSubtitleClassName, 'text-balance text-center')}
            data-bildit-var-name="headerPText"
            data-bildit-var-type="RichText"
          >
            {headerPText}
