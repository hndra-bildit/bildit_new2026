 ...
 */
export function HomeEarlyAccess({ className }) {
  /**
   * @group General
   * @type Boolean
   */
   ...
   * @type RichText
   */
  const divH2Text = 'Join our early access program.'
  /**
   * @group div
   * @type String
   */
  const divImageSrcValue = '/images/home-early-access/line-waves.png'
  /**
   * @group div
   * @type String
   */
  const divLinkHrefValue = '/early-access-program/'
  /**
   * @group div
   * @type Boolean
   */
   ...
   * @type RichText
   */
  const divLinkText = 'Request Access'
  /**
   * @group div
   * @type RichText
   */
        ...
        >
          ...
          <div className="relative z-[1] flex flex-col items-center gap-10">
            <div className="flex justify-center">
              <div
                className={`flex size-16 items-center justify-center bg-white px-3 ${sectionDivRoundedCornersToggle ? 'rounded-2xl' : ''}`}
                data-bildit-var-name="sectionDivRoundedCornersToggle"
                data-bildit-var-type="Boolean"
              >
                <Image
            ...
            <div className="flex max-w-[768px] flex-col gap-2.5 text-center">
              <h2
                ...
                className={cn(homeSectionTitleOnDarkClassName, 'text-[#f0e6ff]')}
              ...
              <p
                className={cn(homeSectionSubtitleOnDarkClassName, 'max-w-none text-lg leading-[29.25px]')}
            ...
            <div className="flex w-full max-w-[900px] flex-col gap-12">
              <div className="flex flex-col items-start justify-center gap-10 md:flex-row md:gap-[60px]">
                <div className="flex flex-col gap-2.5 text-[#f0e6ff]">
                  <p
                    className="font-[family-name:var(--font-uncut-sans)] text-xl font-bold leading-7"
                    data-bildit-var-name="divPText"
                    data-bildit-var-type="RichText"
                  >
                    {divPText}
                  ...
                  <ul className="flex flex-col gap-2.5">
                    {GET_ITEMS.map((item) => (
                      <li key={item} className="flex items-center gap-2.5">
                        <span
                          className={`flex size-6 shrink-0 items-center justify-center text-xs font-bold text-white [background-image:var(--bildit-gradient-check-chip)] ${roundedCorners ? 'rounded-full' : ''}`}
                          aria-hidden
                ...
                <div className="flex flex-col gap-2.5">
                  <p
                    className="font-[family-name:var(--font-uncut-sans)] text-xl font-bold leading-7 text-[#f0e6ff]"
                    data-bildit-var-name="divPText"
                    data-bildit-var-type="RichText"
                  >
                    {divPText}
