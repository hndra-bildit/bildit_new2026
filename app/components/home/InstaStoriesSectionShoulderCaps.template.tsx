// InstaStoriesSectionShoulderCaps:v1.0 legacy=true
 ...
 */
export function InstaStoriesShoulderCapsTop({
  className
}) {
  return <div className={cn('relative z-10 w-full', className)} style={{
    height: INSTA_STORIES_SHOULDER_CAP_HEIGHT_PX
  }}>
      ...
      <div aria-hidden className="relative z-10 flex h-full w-full">
        <div className="min-h-0 flex-1 bg-white" style={{
        borderBottomLeftRadius: r50
      }} />
        <div className={centerBayClassName} />
        <div className="min-h-0 flex-1 bg-white" style={{
        borderBottomRightRadius: r50
      }} />
      </div>
    </div>;
}
...
export function InstaStoriesShoulderCapsBottom({
  className
}) {
  return <div className={cn('relative z-10 w-full', className)} style={{
    height: INSTA_STORIES_SHOULDER_CAP_HEIGHT_PX
      ...
      <div aria-hidden className="relative z-10 flex h-full w-full">
        <div className="min-h-0 flex-1 bg-white" style={{
        borderTopLeftRadius: r50
      }} />
        <div className={centerBayClassName} />
        <div className="min-h-0 flex-1 bg-white" style={{
        borderTopRightRadius: r50
      }} />
      </div>
    </div>;
}
export default InstaStoriesShoulderCapsTop;