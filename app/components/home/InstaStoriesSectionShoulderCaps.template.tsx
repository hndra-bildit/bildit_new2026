// InstaStoriesSectionShoulderCaps:v2 legacy=false
// @template v2
 ...
 */
export function InstaStoriesShoulderCapsTop({ className }) {
  return (
    <div
...
export function InstaStoriesShoulderCapsBottom({ className }) {
  return (
    <div
      className={cn('relative z-10 w-full', className)}
      style={{
