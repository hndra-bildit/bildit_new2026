// HomeWorkflowSocialStrip:v2 legacy=false
// @template v2
...
export function HomeWorkflowSocialStrip({ className, id, variant = 'light', prominent = false }) {
  /**
   * @group span
   * @type RichText
   */
  const span = 'What customers say about BILDIT'
