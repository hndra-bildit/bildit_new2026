...
const containerAspectRatioHeight = $(containerAspectRatioHeight:String="3");
...
const sectionBackgroundImage = $(sectionBackgroundImage:String="flat_wk31_090225_spec_underarmour_fh_1");
...
const SkinnyFullHeroImageStyleVars = ({ id }) => (
  <style global jsx>{`
    @layer template {
      :host, :root {
       @layer container {
          --${id}-container-aspect-ratio: ${containerAspectRatioWidth || '16'} / ${containerAspectRatioHeight || '9'};
...
const SkinnyFullHeroImageColumnStyles = ({ id }) => (
  <style>{`
    ...
    .${id}-aspect-\\[mobile-container\\] picture,
    .${id}-aspect-\\[tablet-container\\] picture,
    .${id}-aspect-\\[desktop-container\\] picture {
      position: absolute;
      inset: 0;
      width: 100%;
      height: 100%;
    }
    .${id}-aspect-\\[mobile-container\\] picture img,
    .${id}-aspect-\\[tablet-container\\] picture img,
    .${id}-aspect-\\[desktop-container\\] picture img {
      object-fit: cover;
...
const SkinnyFullHeroImage = ({ id }) => (
  <>
    ...
    <ResponsiveContainer
        ...
        className={`w-full max-w-full relative justify-center mx-auto overflow-hidden ${topMargin} ${bottomMargin}`}
      >
      <WrapperComponent className="w-full cursor-pointer">
        <PictureResponsiveImage
          ...
          imageClassName="-z-1 object-cover object-center"
          className={`flex w-full max-w-full min-w-0 relative ${id}-aspect-[mobile-container] md:${id}-aspect-[tablet-container]  xl:${id}-aspect-[desktop-container] ${roundedCornersTop} ${roundedCornersBottom}`}
