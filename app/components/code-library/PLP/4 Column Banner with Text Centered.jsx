...
const firstColumnBackgroundColor = $(firstColumnBackgroundColor:Color="#CBA08E");
...
const firstColumnHeadlineContent = $(firstColumnHeadlineContent:RichText="XX Item";color="#FFFFFF");
// endgroup
...
const secondColumnBackgroundColor = $(secondColumnBackgroundColor:Color="#CBA08E");
...
const secondColumnHeadlineContent = $(secondColumnHeadlineContent:RichText="XX Item";color="#FFFFFF");
// endgroup
...
const thirdColumnBackgroundColor = $(thirdColumnBackgroundColor:Color="#CBA08E");
...
const thirdColumnHeadlineContent = $(thirdColumnHeadlineContent:RichText="XX Item";color="#FFFFFF");
// endgroup
...
const fourthColumnBackgroundColor = $(fourthColumnBackgroundColor:Color="#CBA08E");
...
const fourthColumnHeadlineContent = $(fourthColumnHeadlineContent:RichText="XX Item";color="#FFFFFF");
// endgroup
        ...
        {columns.map(({backgroundColor, image, eyebrow, headline, subhead, cta, category}, index) => (
          <WrapperComponent key={index} className="w-full cursor-pointer" href={cta.url} data-aali={cta.adobeTag}>
            <div className={`relative w-full rounded-lg tablet:rounded-2xl overflow-hidden ${backgroundColor} ${(typeof image.slug === 'string' && image.slug.trim()) ? 'aspect-[column] min-h-[120px]' : 'column-content-padding'}`}>
              ...
              <div className={`${(typeof image.slug === 'string' && image.slug.trim()) ? 'absolute inset-0 z-10' : 'relative'} flex flex-col justify-center items-center ${textAlignment[columnAlignment]} column-horizontal-padding overflow-hidden`}>
                {eyebrow?.image?.slug && eyebrow?.image?.slug?.length > 0 ? (
                  ...
                  eyebrow.content && <p className="belk-text-clamp-eyebrow font-bold eyebrow-spacing text-center" data-bildit-var-name={columnEyebrowContentVars[index]} data-bildit-var-type="RichText">{eyebrow.content}</p>
                )}
                ...
                {headline?.image?.slug && headline?.image?.slug?.length > 0 ? (
                  ...
                  headline?.content && <h2 className="my-1 font-bold belk-text-clamp-headline headline-spacing text-center" data-bildit-var-name={columnHeadlineContentVars[index]} data-bildit-var-type="RichText">{headline.content}</h2>
                )}
                ...
                {subhead?.image?.slug && subhead?.image?.slug?.length > 0 ? (
                  ...
                  subhead.content && <h3 className="my-1 belk-text-clamp-subhead subhead-spacing text-center" data-bildit-var-name={columnSubheadContentVars[index]} data-bildit-var-type="RichText">{subhead.content}</h3>
                )}
                ...
                {category && (
                  <p className="belk-text-clamp-category font-bold text-center my-2 px-2" data-bildit-var-name={columnCategoryVars[index]} data-bildit-var-type="RichText">{category}</p>
                )}
              </div>
            </div>
          </WrapperComponent>
