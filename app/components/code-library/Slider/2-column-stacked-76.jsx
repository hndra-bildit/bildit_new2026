...
const columns1 = [
  ...
  },
  {
    ...
    eyebrow: $(firstEyebrow:String="FASHION MOMENT:"),
    headline: $(firstHeadline:String="Standout Sneakers"),
    description: $(firstDescription:String="Colorful pairs to wear everywhere"),
    descriptionTablet: $(firstDescriptionTablet:String="Colorful pairs to\nwear everywhere"),
    descriptionMobile: $(firstDescriptionMobile:String="Colorful pairs to wear everywhere"),
    ctaText: $(firstCtaText:String="Shop Now"),
...
const columns2 = [
  ...
  },
  {
    ...
    eyebrow: $(secondEyebrow:String="FASHION MOMENT:"),
    headline: $(secondHeadline:String="Meet Your New Blues"),
    description: $(secondDescription:String="It’s time to reimagine your denim collection"),
    descriptionTablet: $(secondDescriptionTablet:String="It’s time to reimagine\nyour denim collection"),
    descriptionMobile: $(secondDescriptionMobile:String="It’s time to reimagine\nyour denim collection"),
    ctaText: $(secondCtaText:String="Shop Now"),
