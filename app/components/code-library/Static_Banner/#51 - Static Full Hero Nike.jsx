...
const FiftyOneStaticTemplate = () => {
  // group { Outer Container }
  const containerBackgroundImageSlug = $(containerBackgroundImageSlug:String="wk24_071425_homepage_nike_fh_1");
  ...
  // group { CTA }
  const ctaLink = $(ctaLink:Link="https://www.belk.com/shop-by-brand/nike/");
  ...
  return (
    <>
      ...
      >
        <div className={`flex w-full py-10 px-0 mx-auto bg-[#2d2d2d] ${topMargin} ${bottomMargin}`}>
          <PictureResponsiveImage
            className="z-10 w-full max-w-[1800px] items-center aspect-[32/39] md:aspect-[40/11] mx-auto object-contain"
...
export default FiftyOneStaticTemplate;