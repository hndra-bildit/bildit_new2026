...
const imageSlugAlt = $(imageSlugAlt:String="The Active Shop");
      ...
      >
        ...
        >
          <div className={cn("carousel-container")}>
            ...
            <div aria-label={imageSlug3Alt} className={`${cn("bg-image")} ${cn("bg-image-3")}`}></div>

            {/* Main sequence */}
            <div aria-label={imageSlugAlt} className={`${cn("bg-image")} ${cn("bg-image-1")}`}></div>
            <div aria-label={imageSlug2Alt} className={`${cn("bg-image")} ${cn("bg-image-2")}`}></div>
            <div aria-label={imageSlug3Alt} className={`${cn("bg-image")} ${cn("bg-image-3")}`}></div>
