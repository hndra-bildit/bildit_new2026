...
const headline = $(headline:String="Up to 75% Off");
const summary = $(description:String="Fine Jewelry & Belk Sterling Silver");
// endgroup
...
// group {Image}
const imageSlug = $(imageSlug:String="wk23_070725_newcms_homepage_finejewelry_fh_1");
      ...
      <div className={cn("container")}>
        ...
        >
          <div className={cn("copy")}>
            <h3
              className={`${getFontSizeClass("6xl", "xl")} ${getFontWeightClass(
                "bold"
              )}`}
            >
              {headline}
            ...
            <p
              className={`${getFontSizeClass("xl", "sm")} ${getFontWeightClass(
                "regular"
              )}`}
            >
              {summary}
...
export default FortyTwoStaticTemplate;