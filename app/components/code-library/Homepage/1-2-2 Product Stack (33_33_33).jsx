...
// group: {4. Column Layout} — 1-2-2: hero (large) + 2x2 (small)
const desktopLargeImageAspectRatioWidth = $(desktopLargeImageAspectRatioWidth:String="");
const desktopLargeImageAspectRatioHeight = $(desktopLargeImageAspectRatioHeight:String="");
const desktopSmallImageAspectRatioWidth = $(desktopSmallImageAspectRatioWidth:String="");
const desktopSmallImageAspectRatioHeight = $(desktopSmallImageAspectRatioHeight:String="");
const tabletLargeImageAspectRatioWidth = $(tabletLargeImageAspectRatioWidth:String="");
const tabletLargeImageAspectRatioHeight = $(tabletLargeImageAspectRatioHeight:String="");
const tabletSmallImageAspectRatioWidth = $(tabletSmallImageAspectRatioWidth:String="");
const tabletSmallImageAspectRatioHeight = $(tabletSmallImageAspectRatioHeight:String="");
...
const tabletGridLayout = $(tabletGridLayout:Dropdown[1 Column|grid-cols-1,2 Columns|grid-cols-2,3 Columns|grid-cols-3,4 Columns|grid-cols-4,1-2-2|grid-cols-1-2-2]="grid-cols-1-2-2");
const desktopGridLayout = $(desktopGridLayout:Dropdown[1 Column|grid-cols-1,2 Columns|grid-cols-2,3 Columns|grid-cols-3,4 Columns|grid-cols-4,1-2-2|grid-cols-1-2-2]="grid-cols-1-2-2");
...
const fifthColumnBackgroundImage = $(fifthColumnBackgroundImage:String="wkxx_2025_test_1_2_2_p5");
...
const HolidayOneTwoTwoStyleVars = ({ id }) => (
  <style global jsx>{`
    @layer template {
      :host, :root {
        @layer container {
...
const HolidayOneTwoTwoStyles = ({ id }) => (
  <style>{`
    ...
    @media (width >= 48rem ) {
      ...
      .md\\:${id}-grid-item-5 > a > div > div > div > picture {
        position: absolute;
        inset: 0;
        width: 100%;
        height: 100%;
    ...
    /* Tablet only: hero full-width top, then 2x2 below */
    @media (min-width: 48rem) and (max-width: 79.999rem) {
      .md\\:${id}-aspect-\\[tablet-container\\] {
        aspect-ratio: auto;
        overflow: visible;
      }
      .md\\:${id}-grid-cols-1-2-2-tablet {
        display: grid;
    ...
    @media (width >= 80rem) {
      ...
      .xl\\:${id}-grid-item-5 > a > div > div > div > picture {
        position: absolute;
        inset: 0;
        width: 100%;
        height: 100%;
...
const HolidayOneTwoTwo = ({ id }) => {
  ...
  const getDesktopAspectRatioClass = (index) => {
    // Col 1 = hero (large); cols 2–5 = small cards
    if (index === 0) {
      return `md:${id}-aspect-[tablet-large-image] xl:${id}-aspect-[desktop-large-image]`;
    }
    return `md:${id}-aspect-[tablet-small-image] xl:${id}-aspect-[desktop-small-image]`;
  }

  return (
    <>
      <HolidayOneTwoTwoStyleVars id={id} />
      <HolidayOneTwoTwoStyles id={id} />
      <ResponsiveContainer
        containerBehavior={containerBehavior}
        className={`w-full relative justify-center mx-auto ${topMargin} ${bottomMargin}`}
        data-bildit-var-name="containerBehavior"
        data-bildit-var-type="Dropdown"
        data-bildit-var-default="max-w-centered"
        data-bildit-var-options='[{"label":"Full browser width","value":"max-w-full"},{"label":"Limit to container","value":"max-w-inset"},{"label":"Centered","value":"max-w-centered"}]'
      >
        ...
        {(sectionTitle || sectionSubhead || (sectionCtaContent != null && String(sectionCtaContent).trim() !== '')) && (
          <div className={`flex ${typeof headerContentArrangement === 'string' ? headerContentArrangement : 'flex-col'} relative w-full font-bold mb-4 ${getAlignmentClass()} items-center ${containerBehavior} ${topMargin} mb-4 ${id}-container-title-drop-shadow-${sectionTitleDropShadow}`}
            ...
            data-bildit-var-type="Dropdown"
            data-bildit-var-default="flex-col"
            data-bildit-var-options='[{"label":"Stacked","value":"flex-col"},{"label":"Side by Side","value":"flex-row"}]'
          >
            {sectionTitle && (
        ...
        <div className={`relative w-full grid ${id}-${mobileGridLayout} md:${id}-grid-cols-1-2-2-tablet xl:${id}-grid-cols-1-2-2 ${id}-${gridGap} ${id}-container-text-color ${id}-container-font-family`}
          data-bildit-var-name="mobileGridLayout"
          data-bildit-var-type="Dropdown"
          data-bildit-var-default="grid-cols-1"
          data-bildit-var-options='[{"label":"1 Column","value":"grid-cols-1"},{"label":"2 Columns","value":"grid-cols-2"},{"label":"4 Columns","value":"grid-cols-4"}]'
        >
          ...
          <div className={`flex flex-col z-10 ${columnVerticalAlignment} ${columnHorizontalAlignment} ${textAlignment[columnHorizontalAlignment]} ${id}-column-horizontal-padding ${id}-column-vertical-padding h-full justify-between`}>
            <div>
                  {eyebrow.image.slug && eyebrow.image.slug.length > 0 ? (
                    <PictureResponsiveImage
                      ...
                      imageClassName="-z-1 object-cover object-center"
                      data-bildit-var-name={index === 0 ? "firstColumnEyebrowImage" : index === 1 ? "secondColumnEyebrowImage" : index === 2 ? "thirdColumnEyebrowImage" : index === 3 ? "fourthColumnEyebrowImage" : "fifthColumnEyebrowImage"}
                      data-bildit-var-type="String"
                    />
                  ) : (
                    <p className={`whitespace-pre ${id}-belk-text-clamp-eyebrow font-bold `}
                      data-bildit-var-name={index === 0 ? "firstColumnEyebrowContent" : index === 1 ? "secondColumnEyebrowContent" : index === 2 ? "thirdColumnEyebrowContent" : index === 3 ? "fourthColumnEyebrowContent" : "fifthColumnEyebrowContent"}
                      data-bildit-var-type="RichText"
                      data-bildit-var-default=""
                    >{eyebrow.content}</p>
                  )}
                  ...
                  {headline.image.slug && headline.image.slug.length > 0 ? (
                    <PictureResponsiveImage
                      ...
                      data-bildit-var-name={index === 0 ? "firstColumnHeadlineImage" : index === 1 ? "secondColumnHeadlineImage" : index === 2 ? "thirdColumnHeadlineImage" : index === 3 ? "fourthColumnHeadlineImage" : "fifthColumnHeadlineImage"}
                      data-bildit-var-type="String"
                    />
                  ) : (
                      <h2 className={`my-1 font-bold whitespace-pre ${id}-belk-text-clamp-headline `}
                        data-bildit-var-name={index === 0 ? "firstColumnHeadlineContent" : index === 1 ? "secondColumnHeadlineContent" : index === 2 ? "thirdColumnHeadlineContent" : index === 3 ? "fourthColumnHeadlineContent" : "fifthColumnHeadlineContent"}
                        data-bildit-var-type="RichText"
                        data-bildit-var-default=""
                      >{headline.content}</h2>
                  )}
                  ...
                  {subhead.image.slug && subhead.image.slug.length > 0 ? (
                    <PictureResponsiveImage
                      ...
                      imageClassName="-z-1 object-contain object-center"
                      data-bildit-var-name={index === 0 ? "firstColumnSubheadImage" : index === 1 ? "secondColumnSubheadImage" : index === 2 ? "thirdColumnSubheadImage" : index === 3 ? "fourthColumnSubheadImage" : "fifthColumnSubheadImage"}
                      data-bildit-var-type="String"
                    />
                  ) : (
                    <h3 className={`my-1 whitespace-pre ${id}-belk-text-clamp-subhead `}
                      data-bildit-var-name={index === 0 ? "firstColumnSubheadContent" : index === 1 ? "secondColumnSubheadContent" : index === 2 ? "thirdColumnSubheadContent" : index === 3 ? "fourthColumnSubheadContent" : "fifthColumnSubheadContent"}
                      data-bildit-var-type="RichText"
                      data-bildit-var-default=""
                    >{subhead.content}</h3>
                  )}
                  ...
                  {(cta.content != null && String(cta.content).trim() !== '') && (
                    <Button className={`mt-2 mb-1 ${id}-belk-text-clamp-cta  cursor-pointer ${ctaVariant === 'solid' ? `${id}-bg-solid-button` : ''}`} variant={ctaVariant}
                      data-bildit-var-name={index === 0 ? "firstColumnCtaContent" : index === 1 ? "secondColumnCtaContent" : index === 2 ? "thirdColumnCtaContent" : index === 3 ? "fourthColumnCtaContent" : "fifthColumnCtaContent"}
                      data-bildit-var-type="RichText"
                      data-bildit-var-default=""
                    >{cta.content}</Button>
                  )}
            ...
            return (
              <WrapperComponent key={index} className={`w-full cursor-pointer ${id}-grid-item-${index + 1} xl:${id}-grid-item-${index + 1} md:${id}-grid-item-${index + 1}`} href={cta.url} data-aali={cta.adobeTag}>
                {image.slug && image.slug.length > 0 ? (
                  <div className={columnCardClassName}>
                    <div className={columnImageWrapperClassName}>
                      <PictureResponsiveImage
                        ...
                        data-bildit-var-name={index === 0 ? "firstColumnBackgroundImage" : index === 1 ? "secondColumnBackgroundImage" : index === 2 ? "thirdColumnBackgroundImage" : index === 3 ? "fourthColumnBackgroundImage" : "fifthColumnBackgroundImage"}
                        data-bildit-var-type="String"
                      />
                    </div>
                ...
                {(textBelow.content != null && String(textBelow.content).trim() !== '') && (
                  <p className={`whitespace-pre ${id}-belk-text-clamp-text-below font-bold  text-center my-2`}
                    data-bildit-var-name={index === 0 ? "firstColumnTextBelow" : index === 1 ? "secondColumnTextBelow" : index === 2 ? "thirdColumnTextBelow" : index === 3 ? "fourthColumnTextBelow" : "fifthColumnTextBelow"}
                    data-bildit-var-type="RichText"
                    data-bildit-var-default=""
                  >{textBelow.content}</p>
                )}
...
export default HolidayOneTwoTwo;