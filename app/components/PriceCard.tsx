...
const PriceCard: React.FC<Props> = ({ item }) => {
  ...
  return (
    <div
      className={`px-8 py-10 mt-5  text-grey max-w-[370px] rounded-[14px] ${item.isPopular ? 'bg-[rgba(237,30,121,0.1)]' : 'border border-[#DBDBDB] bg-lighter-gray'}`}
    >
      <label
          ...
          <div className="leading-[18px] text-base">
            ...
            <div>
              <Link href="#" className="flex items-center mt-3">
                ...
                <span className="ml-2 text-base leading-[18px]">Pricing preview</span>
              </Link>
            </div>
          </div>
        )}
